<?php
    ...
    $sql = "select count(*), destination, kategori, panjang, lebar, tinggi, berat, flight from tbl_tracking where id_item = ".$barcode." and posisi_item = ".$pack." and posisi = 'tko'";
    ...
    if(!$valid){
        echo "<script>alert('Barcode Tidak Tersedia Pada Stock Terminal Cargo Out')</script>";
    }
    else{
        $id_tujuan = $get_row[1];
