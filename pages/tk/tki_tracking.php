...
<title>APLOG Tracking System - Terminal Cargo In</title>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
	    ...
	    var barcode = $("#barcode").val();            
            $.get("/pages/tk/tki_detail.php?id="+barcode, function(data, status){
            var markup = data        
...
<div class="container-fluid">
	<div class="main-header"></div>
        <div class="row">
		    ...
		    <br><br>
		            <form method=POST action="/konfigurasi/cis_insert_tki.php">
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-left txt-primary">SMU Number</th>
                                                <th class="text-left txt-primary">Category</th>
                                                ...
                                                <th class="text-center txt-primary">Origin</th>
                                                <th class="text-left txt-primary">Destination</th>
                                                <th class="text-left txt-primary">Flight Number</th>
