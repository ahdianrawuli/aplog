...
<script type="text/javascript">
    ...
    $(document).ready(function(){
	    ...
	    var barcode = $("#barcode").val();            
            $.get("/pages/ra/ra_detail.php?id="+barcode, function(data, status){
            var markup = data        
...
<div class="container-fluid">
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <!--<th class="text-center txt-primary"><font size=2>Harga</font></th>-->
						                        <th class="text-center txt-primary"><font size=2>Doc. PTI</font></th>
    ...
    <div class="col-sm-12">
        <input type="submit" class="btn btn-primary waves-effect waves-light btn-mini" value="SIMPAN">
    </div>
    </div>
